...
- say 'I am ready'
- modified for Falcon3-1b 
  - explain in 1 phrase what is science.
  - Write the summary of the following text, in 2 phrase 2.
  - extract the 3 important points from the provided text. format the output as a python list.
  - Imagine you are writing the table of content of a document, given a text.
write the table of content of the following:
...
Summary:
""",
f"""Write the summary of the following text, in 2 phrase 2.
[text]
{context}
[end of text]
""",
f"""extract the 3 important points from the provided text. format the output as a python list.
[text]
{context}
[end of text]
""",
f"""Imagine you are writing the table of content of a document, given a text.
write the table of content of the following: 
[text]
{context}
[end of text]
""",
f"""Reply to the question only using the provided context. If the answer is not contained in the text say "unanswerable".
[context]
{context}
[end of context]
Rememeber: If the answer is not contained in the text say "unanswerable".
...
""",
f"""List five most important topics from the following text:
[text]
{context}
[end of text]
""",
...
>>>⏱️ Time to First Token: {ttofseconds} seconds
